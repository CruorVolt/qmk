...
#define SEQ_SIX_KEYS(key1, key2, key3, key4, key5, key6) if (leader_sequence[0] == (key1) && leader_sequence[1] == (key2) && leader_sequence[2] == (key3) && leader_sequence[3] == (key4) && leader_sequence[4] == (key5) && leader_sequence[5] == (key6))

#define LEADER_EXTERNS() extern bool leading; extern uint16_t leader_time; extern uint16_t leader_sequence[6]; extern uint8_t leader_sequence_size
